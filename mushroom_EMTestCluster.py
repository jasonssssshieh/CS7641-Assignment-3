...
class ExpectationMaximizationTestCluster():
    ...
    def plot(self, ll, homogeneity, completeness, rand, bic, aic):
            ...
            plt.title('Mushroom: EM, Log Probability')
            #plt.show()
            ...
            plt.title('Mushroom: EM, Homogeneity Score')
            #plt.show()
            ...
            plt.title('Mushroom: EM, Completeness Score')
            #plt.show()
            ...
            plt.title('Mushroom: EM, BIC Score')
            #plt.show()
            ...
            plt.title('Mushroom: EM, AIC Score')
            plt.show()