...
if __name__ == "__main__":
    ...
    tmp.to_csv('rf_mushroom_feature_importances.csv')
    dims = range(1,22)
	...
	tmp.to_csv('rf_mushroom_ann.csv')
	...
	rf_abalone_new_data.to_csv('rf_mushroom_new_data.csv')
	...
	ax.set_title('Mushroom: K-Means Clustering (after Random Forest Filter)')
	ax.set_xlabel('RF1')
	ax.set_ylabel('RF2')
	...
	ax2.set_title('Mushroom: EM Clustering (after after Random Forest Filter)')
	ax2.set_xlabel('RF1')
	ax2.set_ylabel('RF2')
