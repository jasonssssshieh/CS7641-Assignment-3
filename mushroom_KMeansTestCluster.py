...
class KMeansTestCluster():
    ...
    def run(self):
        ...
        for k in self.clusters:
            model = KMeans(n_clusters=k, max_iter=1000, init='k-means++')
    ...
    def plot(self, meandist, homogeneity, completeness, rand, silhouettes):
            ...
            plt.title('Mushroom: Kmeans, Average within cluster SSE')
            #plt.show()
            ...
            plt.title('Mushroom: Kmeans, Homogeneity Score')
           # plt.show()
            ...
            plt.title('Mushroom: Kmeans, Completeness Score')
            plt.show()
            ...
            plt.title('Mushroom-Kmeans-RAND Score')
            plt.show()
            """
