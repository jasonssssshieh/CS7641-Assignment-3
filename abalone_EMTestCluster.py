...
class ExpectationMaximizationTestCluster():
    ...
    def plot(self, ll, homogeneity, completeness, rand, bic, aic):
            ...
            plt.title('Abalone: EM, Log Probability')
            #plt.show()
            ...
            plt.title('Abalone: EM, Homogeneity Score')
            #plt.show()
            ...
            plt.title('Abalone: EM, Completeness Score')
            #plt.show()
            ...
            plt.title('Abalone: EM, BIC Score')
            #plt.show()
            ...
            plt.title('Abalone: EM, AIC Score')
            plt.show()